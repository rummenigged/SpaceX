...
constructor(
    ...
    override suspend fun getPastLaunches(): ResponseOperation<List<Launch>> = withContext(
        Dispatchers.IO
    ) {
        launchApi
    ...
    override suspend fun getUpcomingLaunches(): ResponseOperation<List<Launch>> = withContext(
        Dispatchers.IO
    ) {
        launchApi
